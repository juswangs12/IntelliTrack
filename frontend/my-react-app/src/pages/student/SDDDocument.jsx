  ...
  return (
    <div>
      <div className="page-header">
        <h1 className="page-title">Software Design Document (SDD)</h1>
        <p className="page-description">Submit and track your SDD document</p>
      </div>

      <div className="card">
        <div className="card-header">
          <h2 className="card-title">Upload SDD Document</h2>
